          ...
          <div className="bg-[#0a0a0a]/70 backdrop-blur-lg border border-primary/10 hover:border-primary/30 rounded-[2.5rem] p-8 md:p-14 text-center shadow-[0_0_50px_rgba(212,175,55,0.03)] transition-all duration-500 relative overflow-hidden group">
            ...
            >
               ...
               <div className="flex flex-col sm:flex-row items-center gap-8 relative z-10">
                  <div className="bg-white p-3 rounded-2xl flex items-center justify-center w-20 h-20 shadow-2xl">
                     {/* Yape Logo Verdadero */}
                     <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d1/Yape_text_logo.svg/2560px-Yape_text_logo.svg.png" alt="Yape Logo" className="w-full object-contain" />
                  </div>
